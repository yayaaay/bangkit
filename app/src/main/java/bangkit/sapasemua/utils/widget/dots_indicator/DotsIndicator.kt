...
import amirlabs.sapasemua.utils.widget.dots_indicator.BaseDotsIndicator.Type.DEFAULT
...
class DotsIndicator @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null,
  ...
  override fun addDot(index: Int) {
    ...
    dot.setPadding((dotsElevation * 0.8f).toInt(),(dotsElevation * 2).toInt(),(dotsElevation * 0.8f).toInt(),(dotsElevation * 2).toInt())
